 ...
 *
 *  It has been AutoGen-ed  May 16, 2023 at 12:17:04 AM by AutoGen 5.18.5
...
/*  1427 */ "no\0"
/*  1430 */ "NTPSNMPD\0"
/*  1439 */ "ntpsnmpd - NTP SNMP MIB agent - Ver. 4.3.100\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpsnmpd - NTP SNMP MIB agent - Ver. 4.3.100\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
