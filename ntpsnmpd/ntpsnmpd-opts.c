 ...
 *
 *  It has been AutoGen-ed  February  1, 2017 at 07:34:15 AM by AutoGen 5.18.5
...
/*  1431 */ "no\0"
/*  1434 */ "NTPSNMPD\0"
/*  1443 */ "ntpsnmpd - NTP SNMP MIB agent - Ver. 4.2.8p9-win\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpsnmpd - NTP SNMP MIB agent - Ver. 4.2.8p9-win\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
