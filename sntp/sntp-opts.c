 ...
 *
 *  It has been AutoGen-ed  April  7, 2019 at 02:11:29 AM by AutoGen 5.18.5
...
/*  2307 */ "no-load-opts\0"
/*  2320 */ "SNTP\0"
/*  2325 */ "sntp - standard Simple Network Time Protocol client program - Ver. 4.3.94\n"
...
implied warranty.\n"));
  ...
  puts(_("sntp - standard Simple Network Time Protocol client program - Ver. 4.3.94\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ hostname-or-IP ...]\n"));
