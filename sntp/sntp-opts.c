 ...
 *
 *  It has been AutoGen-ed  April  8, 2019 at 10:09:19 PM by AutoGen 5.18.5
...
/*  2307 */ "no-load-opts\0"
/*  2320 */ "SNTP\0"
/*  2325 */ "sntp - standard Simple Network Time Protocol client program - Ver. 4.3.95\n"
...
implied warranty.\n"));
  ...
  puts(_("sntp - standard Simple Network Time Protocol client program - Ver. 4.3.95\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ hostname-or-IP ...]\n"));
