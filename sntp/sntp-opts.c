 ...
 *
 *  It has been AutoGen-ed  May 24, 2024 at 09:49:30 PM by AutoGen 5.18.16
...
/*  2327 */ "no-load-opts\0"
/*  2340 */ "SNTP\0"
/*  2345 */ "sntp - standard Simple Network Time Protocol client program - Ver. 4.2.8p18-RC2\n"
...
implied warranty.\n"));
  ...
  puts(_("sntp - standard Simple Network Time Protocol client program - Ver. 4.2.8p18-RC2\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ hostname-or-IP ...]\n"));
