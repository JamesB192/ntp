 ...
 *
 *  It has been AutoGen-ed  May 25, 2024 at 02:38:38 AM by AutoGen 5.18.16
...
/*  1870 */ "no\0"
/*  1873 */ "NTPQ\0"
/*  1878 */ "ntpq - standard NTP query program - Ver. 4.3.105\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpq - standard NTP query program - Ver. 4.3.105\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
