 ...
 *
 *  It has been AutoGen-ed  March 21, 2017 at 09:32:56 AM by AutoGen 5.18.5
...
#define zLicenseDescrip (ntpq_opt_strs+351)
 ...
 */
static char const ntpq_opt_strs[2015] =
/*     0 */ "ntpq 4.2.8p10-win-beta1\n"
            "Copyright (C) 1992-2017 The University of Delaware and Network Time Foundation, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the NTP License, copies of which\n"
            "can be seen at:\n"
...
/*  1091 */ "IPV6\0"
/*  1096 */ "ipv6\0"
/*  1101 */ "run a command and exit\0"
/*  1124 */ "COMMAND\0"
/*  1132 */ "command\0"
/*  1140 */ "Increase debug verbosity level\0"
/*  1171 */ "DEBUG_LEVEL\0"
/*  1183 */ "debug-level\0"
/*  1195 */ "Set the debug verbosity level\0"
/*  1225 */ "SET_DEBUG_LEVEL\0"
/*  1241 */ "set-debug-level\0"
/*  1257 */ "Force ntpq to operate in interactive mode\0"
/*  1299 */ "INTERACTIVE\0"
/*  1311 */ "interactive\0"
/*  1323 */ "numeric host addresses\0"
/*  1346 */ "NUMERIC\0"
/*  1354 */ "numeric\0"
/*  1362 */ "Always output status line with readvar\0"
/*  1401 */ "OLD_RV\0"
/*  1408 */ "old-rv\0"
/*  1415 */ "Print a list of the peers\0"
/*  1441 */ "PEERS\0"
/*  1447 */ "peers\0"
/*  1453 */ "Set default display type for S2+ refids\0"
/*  1493 */ "REFID\0"
/*  1499 */ "refid\0"
/*  1505 */ "Display the full 'remote' value\0"
/*  1537 */ "WIDE\0"
/*  1542 */ "wide\0"
/*  1547 */ "display extended usage information and exit\0"
/*  1591 */ "help\0"
/*  1596 */ "extended usage information passed thru pager\0"
/*  1641 */ "more-help\0"
/*  1651 */ "output version information and exit\0"
/*  1687 */ "version\0"
/*  1695 */ "save the option state to a config file\0"
/*  1734 */ "save-opts\0"
/*  1744 */ "load options from a config file\0"
/*  1776 */ "LOAD_OPTS\0"
/*  1786 */ "no-load-opts\0"
/*  1799 */ "no\0"
/*  1802 */ "NTPQ\0"
/*  1807 */ "ntpq - standard NTP query program - Ver. 4.2.8p10-win-beta1\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n\0"
/*  1937 */ "$HOME\0"
/*  1943 */ ".\0"
/*  1945 */ ".ntprc\0"
/*  1952 */ "http://bugs.ntp.org, bugs@ntp.org\0"
/*  1986 */ "ntpq 4.2.8p10-win-beta1\0"
/*  2010 */ "hash";
...
#define IPV4_DESC      (ntpq_opt_strs+1019)
/** Upper-cased name for the ipv4 option */
#define IPV4_NAME      (ntpq_opt_strs+1050)
/** Name string for the ipv4 option */
#define IPV4_name      (ntpq_opt_strs+1055)
...
#define IPV6_DESC      (ntpq_opt_strs+1060)
/** Upper-cased name for the ipv6 option */
#define IPV6_NAME      (ntpq_opt_strs+1091)
/** Name string for the ipv6 option */
#define IPV6_name      (ntpq_opt_strs+1096)
...
#define COMMAND_DESC      (ntpq_opt_strs+1101)
/** Upper-cased name for the command option */
#define COMMAND_NAME      (ntpq_opt_strs+1124)
/** Name string for the command option */
#define COMMAND_name      (ntpq_opt_strs+1132)
...
#define DEBUG_LEVEL_DESC      (ntpq_opt_strs+1140)
...
#define DEBUG_LEVEL_name      (ntpq_opt_strs+1183)
...
#define SET_DEBUG_LEVEL_DESC      (ntpq_opt_strs+1195)
/** Upper-cased name for the set-debug-level option */
#define SET_DEBUG_LEVEL_NAME      (ntpq_opt_strs+1225)
/** Name string for the set-debug-level option */
#define SET_DEBUG_LEVEL_name      (ntpq_opt_strs+1241)
...
#define INTERACTIVE_DESC      (ntpq_opt_strs+1257)
...
#define INTERACTIVE_name      (ntpq_opt_strs+1311)
...
#define NUMERIC_DESC      (ntpq_opt_strs+1323)
/** Upper-cased name for the numeric option */
#define NUMERIC_NAME      (ntpq_opt_strs+1346)
/** Name string for the numeric option */
#define NUMERIC_name      (ntpq_opt_strs+1354)
...
#define PEERS_DESC      (ntpq_opt_strs+1415)
/** Upper-cased name for the peers option */
#define PEERS_NAME      (ntpq_opt_strs+1441)
/** Name string for the peers option */
#define PEERS_name      (ntpq_opt_strs+1447)
...
#define REFID_DESC      (ntpq_opt_strs+1453)
/** Upper-cased name for the refid option */
#define REFID_NAME      (ntpq_opt_strs+1493)
/** Name string for the refid option */
#define REFID_name      (ntpq_opt_strs+1499)
...
#define WIDE_DESC      (ntpq_opt_strs+1505)
/** Upper-cased name for the wide option */
#define WIDE_NAME      (ntpq_opt_strs+1537)
/** Name string for the wide option */
#define WIDE_name      (ntpq_opt_strs+1542)
 ...
 */
#define HELP_DESC       (ntpq_opt_strs+1547)
#define HELP_name       (ntpq_opt_strs+1591)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (ntpq_opt_strs+1596)
#define MORE_HELP_name  (ntpq_opt_strs+1641)
...
#endif
#define VER_DESC        (ntpq_opt_strs+1651)
#define VER_name        (ntpq_opt_strs+1687)
#define SAVE_OPTS_DESC  (ntpq_opt_strs+1695)
#define SAVE_OPTS_name  (ntpq_opt_strs+1734)
#define LOAD_OPTS_DESC     (ntpq_opt_strs+1744)
#define LOAD_OPTS_NAME     (ntpq_opt_strs+1776)
#define NO_LOAD_OPTS_name  (ntpq_opt_strs+1786)
#define LOAD_OPTS_pfx      (ntpq_opt_strs+1799)
...
#define zPROGNAME       (ntpq_opt_strs+1802)
/** Reference to the title line for ntpq usage. */
#define zUsageTitle     (ntpq_opt_strs+1807)
/** ntpq configuration file name. */
#define zRcName         (ntpq_opt_strs+1945)
...
/* extracted from optmain.tlib near line 945 */
    static char const * const names[2] = {
        ntpq_opt_strs+2010, ntpq_opt_strs+1055 };
